/*
 * Project Group 4 SEMI - Dual-Axis Solar Tracker                              // Project title:  A dual-axis solar tracking system
 * Hardware:  Arduino Uno R3, 2 Servos (LR = Continuous, UD = Standard), 4 LDRs // Lists hardware components:  Arduino board, 2 servo motors, 4 light sensors
 * Features: Automatic Mode (Flowchart-based), Manual Mode, Excel Data Logging // Describes the main features of the project
 */
